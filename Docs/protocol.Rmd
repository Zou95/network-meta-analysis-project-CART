...
Records identified through the database searches will be imported into Rayyan, and duplicate records will be removed. Titles and abstracts will be screened against the predefined eligibility criteria, followed by full-text assessment of potentially eligible studies. Study selection will be conducted by a single reviewer (ZB) due to the scope and resource constraints of this project. This approach differs from the standard practice of independent screening by two reviewers and is acknowledged as a methodological limitation. Reasons for exclusion at full-text review will be documented and summarized in a PRISMA 2020 flow diagram.
